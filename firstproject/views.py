...
def index(request):
    # var = {'name': 'Vineet', 'place': 'Ahmedabad'}
...
def analyze(request):
    ...
    if (removepunc != "on" and fullcaps != "on" and newlineremover != "on" and extraspaceremover != "on"):
        return HttpResponse('<h1 style="text-align: center;">ERROR</h1> <br><br> <h1 style="text-align: center;">You have not selected any operation !!! Please select atleast one operation</h1>')
